<template>
  <div class="relative pt-10">
    <!-- صورة القسم كخلفية -->
    <div class="relative h-64 md:h-screen bg-cover bg-center flex items-center justify-center"
    ...
    <div class="space-y-8 p-8">
      <div v-for="(division, index) in divisions" :key="division.id" class="flex flex-col items-center">
        <!-- عنوان الفرع -->
        <h3 class="text-2xl font-semibold">{{ division.titleAr }}</h3>

        <!-- صورة الفرع -->
        <NuxtImg :src="division.imageUrl || 'https://via.placeholder.com/150'" :alt="division.titleAr"
