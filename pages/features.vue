<template>
  <div class=" min-h-screen">
    <v-carousel :height="carouselHeight" show-arrows="false" cycle hide-delimiter-background>
      <v-carousel-item>
        <div class="relative">
          <NuxtImg class="sm:w-100 md:w-[70%] px-4 rounded-xl relative cursor-pointer md:h-[400px] mx-auto"
            src="https://assets.e3arabi.com/wp-content/uploads/2021/01/online-3412473_640-3.jpg" alt="Image" />

        </div>
      </v-carousel-item>
      <v-carousel-item>
        <div class="relative">
          <NuxtImg v-if="$i18n.locale === 'ar-AR'"
            class="sm:w-100 md:w-[70%] px-4 rounded-xl relative cursor-pointer md:h-[400px] mx-auto"
            src="https://iqdamacademy.com/media/main2.jpeg" alt="Image" />
          <NuxtImg v-else class="sm:w-100 md:w-[70%] px-4 rounded-xl relative cursor-pointer md:h-[400px] mx-auto"
            src="https://iqdamacademy.com/media/main2.jpeg" alt="Image" />
      ...
      <v-carousel-item>
        <div class="relative">
          <NuxtImg v-if="$i18n.locale === 'ar-AR'"
            class="sm:w-100 md:w-[70%] px-4 rounded-xl relative cursor-pointer md:h-[400px] mx-auto"
            src="https://i.ytimg.com/vi/XJfXBlhT5H8/hqdefault.jpg" alt="Image" />
          <NuxtImg v-else class="sm:w-100 md:w-[70%] px-4 rounded-xl relative cursor-pointer md:h-[400px] mx-auto"
            src="https://i.ytimg.com/vi/XJfXBlhT5H8/hqdefault.jpg" alt="Image" />
